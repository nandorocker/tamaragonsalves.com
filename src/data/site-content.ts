...
export const siteContent = {
  ...
  services: {
    ...
    courses: {
      ...
      note: "Courses can vary in length and depth, depending on your needs. They can also be tailored to specific audiences such as academics, government, and the general public."
    },
    consultancy: {
      title: "Consultancy",
      description: "My consultancy work focuses on policy analysis, advocacy, research, and capacity-building in human rights, with a particular emphasis on gender-based violence, sexual and reproductive rights, health law, and children's rights. Leveraging my academic foundation—a bachelor's in Law, a master's in Human Rights, a PhD in Law and Society, and a graduate certificate in teaching—I provide insightful, evidence-based solutions tailored to diverse contexts. Grounded on a deep commitment to advancing equity and justice, I can:",
      items: [
    ...
    mentorship: {
      title: "Mentorship",
      description: "I can support you with the following:",
      items: [
