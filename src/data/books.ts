...
export const books: Book[] = [
  {
    titleKey: "alienacaoParental.title",
    ...
    downloadLinks: [
      ...
      {
        textKey: "alienacaoParental.downloadLinks.usp",
    ...
    interviewLinks: [
      {
        textKey: "alienacaoParental.interviewLinks.radioUsp",
      ...
      {
        textKey: "alienacaoParental.interviewLinks.papoJus",
        url: "https://www.youtube.com/watch?v=ypz-RGhrXX8",
        icon: "icon-video"
      },
      {
        textKey: "alienacaoParental.interviewLinks.trf3",
  ...
  {
    titleKey: "direitosHumanos.title",
    author: "Tamara Amoroso Gonçalves",
    descriptionKey: "direitosHumanos.description",
    imageUrl: "livro_direitos_humanos_mulheres.jpg",
    imageAltKey: "direitosHumanos.imageAlt",
    titleUrl: "https://www.amazon.com/Direitos-Humanos-Mulheres-Tamara-Amoroso/dp/8502187805/ref=sr_1_1?crid=36W7YBK85BINN&dib=eyJ2IjoiMSJ9.KwVNe-F1ZUfmrHYW8LSCw-w_CZPuVGIqMQkmkEH6Nbc51LhbYGokNNxgGei35xefXgO_d0dgL-H7LwuOxd0SsA.zTgcc4F9TJUAS7BOAemKVvgbn-2blSP2TE97WhxRrr0&dib_tag=se&keywords=Tamara+Amoroso+Gon%C3%A7alves&qid=1734551323&sprefix=tamara+amoroso+gon%C3%A7alves%2Caps%2C68&sr=8-1",
    purchaseTextKey: "direitosHumanos.purchaseText",
    purchaseLinks: [
      {
        textKey: "direitosHumanos.purchaseLinks.amazon",
      ...
      {
        textKey: "direitosHumanos.purchaseLinks.travessa",
  ...
  {
    titleKey: "abortoReligiao.title",
    author: "Tamara Amoroso Gonçalves (coord.), Thais de Souza Lapa",
    descriptionKey: "abortoReligiao.description",
    imageUrl: "livro_aborto_e_religiao.png",
    imageAltKey: "abortoReligiao.imageAlt",
